        ...
        <Container maxWidth="xl" >
            <Box sx={{textAlign: "left", py: 2, px: 8}}>
                <Stack spacing={1.5} >
                    ...
                    <Stack 
                        direction={screenLessThan800 ? "column" : "row" } 
                        spacing={3} 
                    >
                        {
                    ...
                    <Stack sx={{border: "0.25px solid #53537370"}} spacing={1}>
                        <Stack sx={{px: 4, pt:4}}>
                            ...
                            <Typography variant="body1" sx={{width: "100%", pb: 2, maxWidth: "55rem"}}>
                                { categoryList[active].body }
                            </Typography>
                            <OutlinedBtn sx={{width: "fit-content"}} text={"Explore " + categoryList[active].title} />
                        </Stack>
                        <CourseCarousel />
                    </Stack>
                </Stack>
